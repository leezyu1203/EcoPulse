...
import com.example.ecopulse.Reminder.AlarmReceiver;
...
public class RequestListAdapter extends ArrayAdapter<RequestListItem> {
    ...
    public void addCustomerTask(String userID, RequestListItem item, String recyclingCenterName) {
        ...
        com.example.ecopulse.Reminder.Model.Task task =
                new com.example.ecopulse.Reminder.Model.Task("Recycling Pick Up Schedule", recyclingCenterName, date, time, requestCode, id);
    ...
    public void addCollaboratorTask(String customerName, String recyclingCenterUserId, RequestListItem item) {
        ...
        // Create a Task object with the request list item information
        com.example.ecopulse.Reminder.Model.Task collabTask =
                new com.example.ecopulse.Reminder.Model.Task("Pick Up Request", description, date, time, requestCode, id);
    ...
    private void setAlarm(com.example.ecopulse.Reminder.Model.Task task){
